...
contains
 ...
 diag_meta(iLookDIAG%scalarTotalSoilWat)              = var_info('scalarTotalSoilWat'             , 'total mass of water in the soil'                                    , 'kg m-2'          , get_ixVarType('scalarv'), lFalseArry, integerMissing, iMissArry)
 ! variable shortcuts
 ...
 flux_meta(iLookFLUX%drainableWater)                  = var_info('drainableWater'                 , 'total outflow from each soil layer'                               , 'm'               , get_ixVarType('midSoil'), lFalseArry, integerMissing, iMissArry)
 ...
 ! number of trials
 indx_meta(iLookINDEX%numberFluxCalc)        = var_info('numberFluxCalc'       , 'number of flux calculations'                                             , '-', get_ixVarType('scalarv'), lFalseArry, integerMissing, iMissArry)
 indx_meta(iLookINDEX%numberStateSplit)      = var_info('numberStateSplit'     , 'number of state splitting solutions'                                     , '-', get_ixVarType('scalarv'), lFalseArry, integerMissing, iMissArry)
 indx_meta(iLookINDEX%numberDomainSplitNrg)  = var_info('numberDomainSplitNrg' , 'number of domain splitting solutions for energy'                         , '-', get_ixVarType('scalarv'), lFalseArry, integerMissing, iMissArry)
 indx_meta(iLookINDEX%numberDomainSplitMass) = var_info('numberDomainSplitMass', 'number of domain splitting solutions for mass'                           , '-', get_ixVarType('scalarv'), lFalseArry, integerMissing, iMissArry)
 indx_meta(iLookINDEX%numberScalarSolutions) = var_info('numberScalarSolutions', 'number of scalar solutions'                                              , '-', get_ixVarType('scalarv'), lFalseArry, integerMissing, iMissArry)
 ...
 USE ascii_util_module,only:linewidth                  ! mach character number for one line
